...
//represents a ChooseLevel class (includes Random and Smart buttons)
public class ChooseLevel extends JPanel
{
    ...
    //returns Random button so an ActionListener can be added to it
    public JButton getBtnRandom()
    {
        return btnRandom;
    }

    //returns Smart button so an ActionListener can be added to it
    public JButton getBtnSmart()
    {
        return btnSmart;
    }

    //customizes the instructions label and buttons that can be seen while a user is choosing 
    //the level of rational behavior they would like to see
    ...
    //customizes the Random and Smart button
