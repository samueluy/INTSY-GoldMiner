    ...
    * */
    public void play()
    {
        ...
        if(pitFlag == 1)
            ...
            System.out.println("Russian Man: You win");
        }
       /* for (int i = 0; i < finalSet.size(); i++) {
            if(!finalSet.get(i).contains("Rotate"))
                System.out.println("Move: "+finalSet.get(i));
        }*/
    ...
    public void action(String dir)
    {
        ...
        if(validMove(dir,xCoord,yCoord))
        {
            ...
            tempBoard.display();
            pathCost+=1;
            //System.out.println("OLD DATA TYPE "+tempBoard.get);
        }
        //Agent uses scan.
